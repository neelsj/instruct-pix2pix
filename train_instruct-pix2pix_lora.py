...
import diffusers
from diffusers import AutoencoderKL, DDPMScheduler, EulerAncestralDiscreteScheduler, DiffusionPipeline, UNet2DConditionModel
...
def main():
    ...
    #noise_scheduler = EulerAncestralDiscreteScheduler.from_config(noise_scheduler.config)
